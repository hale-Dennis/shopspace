  ...
  void checkUser() async {
    await chats
        ...
        if (querySnapshot.docs.isNotEmpty) {
          ...
          /*adding user to a users contacts*/
          //adding to current user's list of contacts
          ...
          await docUser.set(jsonOne);

          //adding current user to friend's list of contacts
